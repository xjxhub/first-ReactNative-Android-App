        ...
        if ( this.state.loading ) {
            return (
                <View style={ styles.loader.container }>
                  <Animated.Image source={ require( '../img/loader-icon.png' ) } style={[
                      styles.loader.icon,
                      { transform: [
                ...
                >
                  <View style={[ styles.player.container, this.styles.containerStyle ]}>
                    <Video
                        ...
                        // source={require('../video/testVideo.mp4')}
                        source={{uri:'http://192.168.0.250:8004/resource/纯电动汽车总体结构认知-微课.mp4'}}
                    />
                      { this.renderError() }
